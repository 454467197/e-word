...
if(custom) { //自定义配置
    ...
    let pathConfig = {
        name:"workflow_mobx", //打包的功能名，参照此文件底部的说明配置
        srcPath:"C:/work/ecology9", //本地源代码路径src4js的上一层，比如main的完整的路径为：./project/WEAVER_E9/src4js/pc/main/index.js
        ...
        runPath:"C:/work/ecology9", //这个地址可以选择输出到源码环境、demo、补丁包中
        mode:mode
    }
	
    if (argv.pubModule) {
        pathConfig.name = argv.pubModule;
    }
    // const pathConfig = {
    //     name:"antd", //打包的功能名，参照此文件底部的说明配置
    //     srcPath:"./WEAVER_CloudStore_ec", //本地源代码路径src4js的上一层，比如main的完整的路径为：./project/WEAVER_E9/src4js/pc/main/index.js
    //     runPath:"D:/E9_workspace/ecology/cloudstore/resource/pc/com/v1", //这个地址可以选择输出到源码环境、demo、补丁包中
    //     mode:mode
    // }

    // const pathConfig = {
    //     name:"ecCom", //打包的功能名，参照此文件底部的说明配置
    //     srcPath:"./WEAVER_CloudStore_ec", //本地源代码路径src4js的上一层，比如main的完整的路径为：./project/WEAVER_E9/src4js/pc/main/index.js
    //     runPath:"D:/E9_workspace/ecology/cloudstore/resource/pc/com/v1", //这个地址可以选择输出到源码环境、demo、补丁包中
    //     mode:mode
    // }
    ...
    // const pathConfig = {
    //     name:"weaCom", //打包的功能名，参照此文件底部的说明配置
    //     srcPath:"./WEAVER_CloudStore_ec", //本地源代码路径src4js的上一层，比如main的完整的路径为：./project/WEAVER_E9/src4js/pc/main/index.js
    //     runPath:"D:/E9_workspace/ecology/cloudstore/resource/pc/com/v1", //这个地址可以选择输出到源码环境、demo、补丁包中
    //     mode:mode
    // }
...
/*
 ...
 com_demo - 组件库 api 文档
 esearch - 微搜 mobx
 esearch_single - 微搜 mobx 单页
 smallApp - 小模块集合 mobx
 smallApp_single - 小模块集合 mobx 单页
 odoc - 公文 mobx
